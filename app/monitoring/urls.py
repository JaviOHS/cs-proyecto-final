...
from app.monitoring.views import monitoring_session, real_time_monitoring, theft_evidence, notifications
...
urlpatterns = [
    ...
    path('theft_evidence/<int:pk>', theft_evidence.TheftEvidenceList.as_view(), name='theft_evidence'),
